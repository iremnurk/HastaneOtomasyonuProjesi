...
namespace Hastane_Proje
{
    public partial class FrmSekreterDetay : Form
    {
        ...
        //TCNO yu taşımak için public string değişken oluşturmak
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            komutkaydet.ExecuteNonQuery();//insert komutu olduğu için değişiklikleri gerçekleştirmek için 
            bgl.baglanti().Close();
        ...
        {
            FrmRandevuListesi1 frl = new FrmRandevuListesi1();
            frl.Show();
        }
